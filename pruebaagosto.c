...
factordim=3; /*Numero de veces que es más grande el grid mesh utilizado -siempre cuadrado- que el objeto a estudiar -también cuadrado-*/
...
FILE  *fu1, *fprueba;
d=0.5;
N=100; /*Número de rayos por cada ángulo de adquisición*/
deltaX=deltaY=0.1; /*Intervalo o paso del mesh grid*/
deltaP=0.01; /*Tamaño de cada detector*/
deltaPaso=0.01; /*Intervalo de propagación del rayo en cada iteración*/
...
objeto=crea_matriz(factordim*dimx, factordim*dimy, factordim*dimx/8, factordim*dimy/8);
