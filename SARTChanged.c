	 ...
	 {	
		...
		{//~ printf("cont2=%d, numhilo=%d\n", cont2, omp_get_thread_num());
			...
			{//~ {	printf("nozeros=%d\n", nonum[cont][cont4].nonnum);
					...
					cant+=nonum[cont][cont4].as[cont5]*(*(x+(nonum[cont][cont4].pixeles[0][cont5])*dimy+nonum[cont][cont4].pixeles[1][cont5]));
